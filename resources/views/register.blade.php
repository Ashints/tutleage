...
?>
        ...
        <form class="abc" action="{{url('store')}}" method="POST">
            @csrf
            ...
            <hr>
                <label for="firstname"><b>First Name</b></label>
                    ...
                    <input class="form-control" type="eamil" name="email" required><br><br>

                    <label for="phonenumber"><b>Phone Number</b></label>
                    <input  class="form-control" type="text" name="phonenumber" minlength="10" maxlength="10" required><br><br>
